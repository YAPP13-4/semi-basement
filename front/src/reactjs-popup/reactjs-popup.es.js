  ...
  (function(_React$PureComponent) {
    function Popup(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(Popup).call(this, props)
      )
            ...
            _defineProperty(
                          ...
                          _defineProperty(
                            _defineProperty(
                              _defineProperty(
                                ...
                                {
                                  isOpen:
                                    _this.props.open || _this.props.defaultOpen,
                                  modal: _this.props.modal
                                    ? true
                                    : !_this.props.trigger // we create this modal state because the popup can't be a tooltip if the trigger prop doesn't exist
                                }
                              ),
                              "lockScroll",
                              function() {
              ...
              function() {
                ...
                if (keepTooltipInside || Array.isArray(position))
                  positions = _toConsumableArray(positions).concat(
                    POSITION_TYPES
                  )
                ...
                if (
                  window
                    .getComputedStyle(_this.TriggerEl, null)
  ...
  (function(_React$PureComponent2) {
    function Ref(props) {
      ...
      return _possibleConstructorReturn(
        this,
        _getPrototypeOf(Ref).call(this, props)
      )
    }
