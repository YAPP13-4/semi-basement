...
export const LOAD_CHART_SONG_INFO_REQUEST = `${NAME}/LOAD_CHART_SONG_DETAIL_REQUEST`
export const LOAD_CHART_SONG_INFO_SUCCESS = `${NAME}/LOAD_CHART_SONG_DETAIL_SUCCESS`
export const LOAD_CHART_SONG_INFO_FAILURE = `${NAME}/LOAD_CHART_SONG_DETAIL_FAILURE`
