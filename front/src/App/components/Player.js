...
const Player = ({
    ...
    return (
        <div className={cx(`${moduleName}`) }>
            <div className={cx(`${moduleName}`+(meta.toggleHistory ? '-history' : '-none')  ) }>     
          ...
          <div style={{display : (meta.toggleHistory? 'block' : 'none') }}  className={cx(`${moduleName}__historyTab`)}> <HistoryTab />  </div>
        </div>
    );
  };
